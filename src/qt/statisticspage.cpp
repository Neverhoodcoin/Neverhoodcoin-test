...
void StatisticsPage::updateStatistics()
{
    ...
    {
        phase = "X11 POW (POS Starts Block 7200)";
    }
    ...
    {
		subsidy = "171,900 THEO per block";
    }
	else if(pindexBest->nHeight < 99)
    {
		subsidy = "0 THEO per block - Instamine Prevention";
    }
	else if(pindexBest->nHeight < 1440)
    {
		subsidy = "1000 THEO per block";
    }
	else if(pindexBest->nHeight < 2880)
    {
		subsidy = "750 THEO per block";
    }
	else if(pindexBest->nHeight < 4320)
    {
        subsidy = "500 THEO per block"; 
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"lightgreen\">" + qVolume + " THEO" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"lightred\">" + qVolume + " THEO" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " THEO");
    }
