// Copyright (c) 2014 The Neverhoodcoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("Neverhoodcoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("Neverhoodcoin-smsg-pow"); // Make this thread recognisable
